...
GO
-- [user_site]
INSERT INTO [user_site](firstname, lastname, username, gender, birthday, [image], email, phone, [password], [status], [banned_reason], account_create_date) VALUES
...
('Nguyen Cong', 'Hieu', 'nchieu', 'hieu.jpg', 'hieuncce180986@fpt.edu.vn', 'ee608a70e3a536f1af3726bbd8bd0b55', 1), --nchieu
('Tran Gia', 'Bao', 'tgbao', 'bao.jpg', 'baotgce181662@fpt.edu.vn', 'e405faf13f35eb5807579887f2e44220', 1), --tgbao
('Bach Cong', 'Chinh', 'bcchinh', 'chinh.jpg', 'chinhbcce181383@fpt.edu.vn', 'b985d6107f576d8fce6bfc9c3ac7d57a', 1), --bcchinh
('Mai Phuc', 'Thanh', 'mpthanh', 'thanh.jpg', 'thanhmpce181394@fpt.edu.vn', 'e8dd6c0a56a63469dad05603a24531ee', 1), --mpthanh
('Cao Huynh Ngoc', 'Nhu', 'nhuchn', 'nhu.jpg', 'nhuchnce181233@fpt.edu.vn', '95db3c918ce2967cbed533d443f2ebf0', 1); --chnnhu
go
...
('Bao Tran', N'67P7C Nguyễn Văn Cừ Nối dài', 916, 31144, 1),
('Hieu Nguyen', N'12 Lý Thái Tổ', 855, 29542, 1),
('Hieu Nguyen', N'01 Hoàng Diệu', 883, 30280, 1),
('Chinh Bach', N'18 Trần Hưng Đạo', 917, 31153, 1),
('Chinh Bach', N'33 Hàng Bông', 933, 31378, 1),
('Thanh Mai', N'5B Lý Tự Trọng', 857, 29575, 1),
('Le Chau', N'5B Trần Văn Khéo', 884, 30316, 1),
('Nhan Tran', N'20C Trần Văn Khéo', 916, 31149, 1),
('Nhan Tran', N'30B3E Trần Hưng Đạo', 916, 31150, 1),
('Hung Pham', N'10B Lê Lợi', 858, 29623, 1),
('Hung Pham', N'50K Đồng Khời', 886, 30337, 1),
('Kim Pham', N'35G Đống Đa', 918, 31168, 1),
('Kim Pham', N'Số 20D Lê Duẩn', 930, 31318, 1),
('Quynh Nguyen', N'10B Hạ Long', 859, 29659, 1),
('Quynh Nguyen', N'50K Trần Phú',887, 30376, 1),
('Tuan Dang', N'45M Phạm Văn Đồng', 919, 31186, 1),
('Tuan Dang', N'30F Quang Trung', 931, 31340, 1),
('Minh Vo', N'22A Nguyễn Thị Minh Khai', 860, 29719, 1),
('Minh Vo', N'7B Nguyễn Thái Bình', 888, 30406, 1),
('Huong Truong', N'50G Bạch Đằng', 923, 31207, 1),
('Huong Truong', N'50G Bạch Đằng', 932, 31342, 1),
('Khai Nguyen', N'24C Trần Phú', 861, 29770, 1),
('Khai Nguyen', N'36D Nguyễn Thái Học', 889, 30463, 1),
('Binh Tran', N'34E Bạch Dương', 924, 31211, 1),
('Binh Tran', N'78F Lê Duẩn', 933, 31366, 1),
('Ngoc Nguyen', N'22B Hải Tân', 862, 29821, 1),
('Ngoc Nguyen', N'23E Hải Sơn', 890, 30502, 1),
('Thu Hang', N'15C Tân Cương', 925, 31222, 1),
('Thu Hang', N'14E Quyết Thắng', 934, 31393, 1),
('Tien Le', N'26D Hòa Phú', 863, 29773, 1),
('Tien Le', N'187T Bạch Dương', 891, 30544, 1),
('Phat Tran', N'10A Lê Lợi', 926, 31299, 1),
('Phat Tran', N'145B Nguyễn Văn Cừ', 935, 31441, 1),
('Vu Quang', N'10A Nguyễn Đình Chiểu', 855, 29545, 1),
('Vu Quang', N'149D Lê Văn Duyệt', 892, 30589, 1),
('Anh Nguyen', N'87C Nguyễn Văn Linh', 927, 31258, 1),
('Anh Nguyen', N'19B Lê Lợi', 936, 31483, 1),
('Thuy Truong', N'87B Phạm Văn Đồng', 857, 29578, 1),
('Tram Vo', N'600 Nguyễn Văn Cừ Nối dài', 916, 31141, 1),
('Tram Vo', N'84D Mậu Thân', 916, 31129, 1),
('Thuan Nguyen', N'10A Lê Lợi', 893, 30628, 1),
('Thuan Nguyen', '178D Trần Hưng Đạo', 917, 31154, 1),
('Wei Ching', N'65P Quang Trung', 937, 31471, 1),
('Wei Ching', N'80T Trần Phú', 858, 29626, 1),
('Bao Nguyen', N'12G Lý Thường Kiệt', 894, 30682, 1),
('Bao Nguyen', N'18I Phan Bội Châu', 918, 31169, 1);
go
...
('Flours (Korean/Japan)', 9, 1),
('Others (Korean/Japan)', 9, 1),
-- Others
('Jam, honey', 10, 1),
('Cheese', 10, 1),
-- Cake Tools
...
--============================================================================================================== 1ng duy nhat (Thanh)
-- [product]
insert into [product]([categoryID], [name], [description], [product_image], [product_rating], [is_deleted]) values
--Chocolate Cakes
(13, 'Classic Chocolate Truffle Cake', 'Satiate your taste a buds right away! Enrich with chocolate sponge & truffle cream. Topped with white chocolate garnish and cherry, it is sure to leave you omnomnom!', 'images/choco_truffle', 0, 1),
(13, 'Chocolate Vanilla Half & Half Cake', 'The perfect blend of tempting chocolate and irresistible vanilla flavours topped up with a cherry and some chocolate shavings.', 'images/hvanilla_hchoco', 0, 1),
(13, 'KitKat Chocolate Truffle Cake', 'Rich in melt-in-mouth chocolates, layered with Inside- Chocolate Truffle With Chopped Kitkat and chunks which make this cake an irresistible one.', 'images/kitkat_truffle', 0, 1),
(13, 'Chocolate Sensation Drip Cake', 'Experience a bite of our stunning Chocolate Cake, where velvety layers meet a cascade of rich chocolate ganache. Adorned with elegant swirls and delicate chocolate chips, it"s a feast for every palate.', 'images/chocolate_drip', 0, 1),
(13, 'Chocolate Ferrero Rocher Almonds Cake', 'A soul pleasing treat to celebrate your occasion! Enriched and coated with exotic chocolates, this cake is embellished with crunchy Ferrero Rochers, hazelnut flavour, and chocolate syrup.', 'images/choco_ferrero_almond', 0, 1),
--Vanilla Cakes
(14, 'Classic Vanilla Caramel Cake', 'Round shaped vanilla cake with whipped cream all over and icing between layers of soft and sweet sponge. It is embellished with streaks and caramel glaze on top, giving it an unmatched sweetness coupled with whipped cream and vanilla essence.', 'images/vani_caramel', 0, 1),
(14, 'Fruits & Sprinkles Vanilla Cake', 'Fruitful vanilla is your healthy snack for the day! Baked with layers of sponge cake, Inside- Custard Cream With Chopped Fruits and buttercream frosting, each bite is blissful and heavenly!', 'images/fruit_sprinkle_vani', 0, 1),
(14, 'Roses Topped Vanilla Cream Cake', 'Indulge in the pure joy of our creamy vanilla dream, a perfect circle of delight, blanketed in a fluffy cloud of whipped perfection. The cake comes topped with real flowers for a glamorous appeal.', 'images/rose_top_vani', 0, 1),
(14, 'Fresh Fruits & Roasted Almonds Cake', 'With farm-fresh fruits inside the cream layers and topped over a vanilla cake with almond shavings, your tastebuds will do the sweet-tango dance.', 'images/fruit_roast-almond', 0, 1),
(14, 'Vanilla Cream Cake', 'Our vanilla cake comes with whipped cream frosting, vibrant sprinkles, & irresistible chocolate shards on top.', 'images/vani_cream', 0, 1),
--Pineapple Cakes
(15, 'Whipped Cream Pineapple Cake', 'A pineapple flavoured cake with whipped cream, pineapple jelly, white chocolate shards adorned with a cherry on top.', 'images/whip-cream_pine', 0, 1),
(15, 'Tropical Pineapple Cake', 'Fresh pineapple cake with a tender base adorned with juicy fruit slices, delicate piping, and a chic chocolate drizzle for a tropical treat.', 'images/tropical_pine', 0, 1),
(15, 'Floral Pineapple Cream Cake', 'A fresh & soothing pineapple cake, full of fresh, juicy chunks of your favourite fruit along with a smooth creamy layer,', 'images/floral_pine', 0, 1),
(15, 'Blue Cream Pineapple Cake', 'With fluffy layers of cake & charming white flowers made of whipped cream along with chunks of pineapple, this cake is a delight.', 'images/blue-cream_pine', 0, 1),
(15, 'Zesty Pineapple Cake', 'Zesty pineapple cake with a blush of pink, a flavor explosion that will have you craving for more. The cake comes topped with real flowers for a glamorous appeal.', 'images/zesty_pine', 0, 1),
--Fruit Cakes
(16, 'Fresh Fruits Topped Red Velvet Cake', 'Fruity delicious! The sinful velvet cake loaded with Inside- Custard Cream With Chopped Fruits like kiwis, cherries, apples, dragon fruits and black grapes. Your healthy treat is on its way!', 'images/fruit_top-red-velvet', 0, 1),
(16, 'Fruit Medley Cake', 'Get lost in a burst of freshness with our summer-perfect Fruit Cake, adorned with an array of luscious, colourful fruits atop moist, tender layers. An irresistible treat for every celebration!', 'images/fruit_medly', 0, 1),
(16, 'Heart Shape Fruits & Nuts Cake', 'Garnished with fresh assortment of tropical fruits, this vanilla cake is coated with handfolded cream & crushed almonds.', 'images/heart_fruit_nuts', 0, 1),
(16, 'Fruit Pastries', 'For the times when your celebration needs a refreshing kick-start, this fruit pastries is here to load your occasion with bliss. The freshly baked pastries topped with juicy fruits like pineapple, cherries, kiwi, orange and grapes would give a healthy twist to your celebrations.', 'images/fruit_pastries', 0, 1),
(16, 'Fresh Fruits Topped Almonds Cake', 'Made of three layers of vanilla cake base, topped with fresh tropical fruits, whipped white cream & roasted crushed almonds.', 'images/fresh-fruit_top-almond', 0, 1),
--Cartoon Cakes
(17, 'Pretty Peppa Pig Cake', 'Jump into muddy puddles with our delightful baby blue Peppa Pig Cake! Perfect for Peppa fans, this charming cake brings joy and excitement to every celebration. A treat as fun and sweet as Peppa herself!', 'images/peppa', 0, 1),
(17, 'Doraemon Cream Cake', 'Doraemon has been the most loved animation character for each kid for quite a while now. So think about their reaction when they see their most loved animation character on their birthday cake. They will start jumping with excitement. So just order this delicious cake and surprise them on their special day.', 'images/doraemon', 0, 1),
(17, 'Rawr Dino Theme Cake', 'Rawr Goes the Dinosaur! Make birthdays roar with this extra adorable Jungle Cake. Pink, delightful and full of adventure, topped with some green grass and a cute dinosaur for themed party fun!', 'images/dino', 0, 1),
(17, 'Charming Brown Bear Theme Cake', 'Adorable bear-faced cake will transform any celebration into a magical wonderland! Delight your loved ones with this heartwarming masterpiece that symbolizes love, warmth, and affection.', 'images/brown_bear', 0, 1),
(17, 'Swirly Minnie Mouse Cake', 'Sprinkle some magic with this Minnie Mouse Cake! Adorned with pink cream swirls, dripping cream, and silver sprinkles, it"s the perfect centrepiece for your little one"s birthday celebration!', 'images/minie_mouse', 0, 1),
--Cakes For Boys
(18, 'Jungle Joy Lion Cake', 'Roar into fun with our jungle-themed cake! Adorned with a cute lion figurine, lush leaves, and vibrant decorations, it"s a visual and flavorful delight in multiple delicious flavors!', 'images/jungle_lion', 0, 1),
(18, 'Jungle Safari Fondant Cake', 'Step into a whimsical world with this jungle theme fondant cake! This delightful creation features a delectable cake base, customizable to your preferred flavor.', 'images/jungle_safari', 0, 1),
(18, 'Cricket Field Fondant Cake', 'Score big with this cricket-themed fondant cake, featuring a vibrant green field cake base and a meticulously crafted cricket ball.', 'images/cricket_field', 0, 1),
(18, 'Quirky Gadget Cream Cake', 'Introducing this gorgeous and delicious theme Cake, an enchanting creation that tantalizes both the eyes and the taste buds.', 'images/gadget', 0, 1),
(18, 'Rocket Fondant Cake', 'Is your child curious about rocket science? If yes, then this incredible cake would be the best birthday gift for him. ', 'images/rocket', 0, 1),
--Cakes For Girls
(19, 'Beautiful Butterfly Theme Cake', 'Mutli Flavour Cake in Cream with sugar sheet butterfly artwork', 'images/butterfly', 0, 1),
(19, 'Happy Girl Fondant n Cream Half Cake', 'Indulge in pure delight with this enchanting half cake creation - a masterpiece made like a cutie cartoon character.', 'images/happy_girl', 0, 1),
(19, 'Rose N Butterfly Designer Cake', 'Behold this stunning cake, available in various flavours and adorned with delicate cream roses and edible butterfly artwork.', 'images/rose_butterfly', 0, 1),
(19, 'Adorable Pink Its A Girl Fondant Cake', 'Celebrate the arrival of your baby girl and welcome her to your home with this saccharine delight.', 'images/pink_fondant', 0, 1),
(19, 'The Princess Crown Cake', 'The perfect gift choice, this confectionary delight promises to mesmerize and delight the recipient, creating unforgettable memories.', 'images/crown', 0, 1),
--Jar Cakes
(20, 'Red Velvet Single Jar Cake', 'Nothing matches to the goodness of a delectable red velvet jar cake and when it comes as a jar cake, it is sure to spread happiness and other good feelings to your loved ones. ', 'images/red-velvet_jar', 0, 1),
(20, 'Butterscotch Single Jar Cake', 'Crunchy butterscotch and smooth, creamy butterscotch flavoured bread confined into a cute little glass jar - This jar cake is a perfect charmer for a sweet luxury.', 'images/butterscotch_jar', 0, 1),
(20, 'Banoffee Jar Cake Set', 'Get your hands on this scrumptious jar cake that comes in the flavor of your favorite banoffee pie.', 'images/banoffee_jar', 0, 1),
(20, 'Oreo Single Jar Cake', 'Who doesn"t Love Oreo cookies? Who doesn"t Love Cake? So, with our "The Oreo Cutiepie", oreo jar cake, you can meet both the loves at the same time in the most lip-smacking way.', 'images/oreo_jar', 0, 1),
(20, 'Blueberry Single Jar Cake', 'Our "Cute Blueberry Delight" is nothing less than a heaven of desserts.', 'images/blueberry_jar', 0, 1),
--Cheese Cakes
(21, 'Classic Blueberry Cheesecake', 'Indulge in a velvety smooth cheesecake topped with a luscious, glossy blueberry glaze, its vibrant hue hinting at the rich and tangy flavor.', 'images/blueberry_cheese', 0, 1),
(21, 'Lotus Biscoff Baked Cheesecake', 'Gourmet Lotus Biscoff Baked Cheesecake with a base of crumbly crust topped with velvety cheese cream, covered in rich Biscoff spread, and garnished with a signature Lotus biscuit.', 'images/lotus_cheese', 0, 1),
(21, 'Crunch Topped Cheesecake Pastry', 'Dial up the fun filled celebrations with this dreamy and crumbly delicious sweet cheesecake today, add the mystique of enchantment in an instant!', 'images/cheese_pastry', 0, 1),
(21, 'Candied Caramel Mousse', 'Surround and satisfy yourself with deliciousness in this decadent caramel cheese mousse.', 'images/candy_mousse', 0, 1),
(21, 'Blueberry Cheese Pastry', 'Cheese has found a quite popular place in the dessert menu of many people. To all the cheese lovers out there! We bring you a mouthwatering flavour of the cheese.', 'images/blueberry_cheese_pastry', 0, 1),
--Cookies
(22, 'Wholesome Corn Cookies', 'Favorite among all agar group Corn cookies are bliss to your tastebuds.', 'images/wholesome_corn', 0, 1),
(22, 'Handmade Almond Cookies', 'Who doesn"t love crunchy and delicious cookies? The distinctive, delicious and uncommon taste of almond cookies will quickly your taste buds. ', 'images/handmade_almond', 0, 1),
(22, 'Coconut Cookies', 'If coconut is on your baking list then you can not miss these freshly baked coconut cookies.', 'images/coconut_cookie', 0, 1),
(22, 'Choco Chip Cookies', 'A cookie made in heaven. If you are craving for something chocolaty then these melt-in-mouth cookies are your perfect pick.', 'images/chocochip', 0, 1),
(22, 'Multi Grain Cookies', 'Let"s go crackers for these multi-grain cookies! Packed with the goodness of assorted seeds and nuts, these crunchy treats are perfect for a wholesome snack. Enjoy the healthy, nutty crunch!', 'images/multi_grain', 0, 1),
--Year Anniversary Cakes
(23, 'Number One Cream Cake', 'From your little one"s 1st birthday to 1st year of togetherness, every special day of your and your loved one"s life will be made memorable as you spread your greetings over his confetti cake.', 'images/number1_cream', 0, 1),
(23, 'Red Velvet Pinata Cake', 'This Red Velvet Pinata Cake is a delightful masterpiece adorned with charming red & white hearts on top.', 'images/red-velvet_pinata', 0, 1),
(23, 'Square Shaped Anniversary Cake', 'The successful first year of togetherness - This day is very important in every married couple"s life, this day is the day when they got lucky and got married to the person who was going to be by their side for the rest of their life.', 'images/number1_square', 0, 1),
(23, 'Round-Shaped 25th Anniversary Poster Cake', 'You both have sailed through many ups and downs of life together, and it"s been twenty-five years now.', 'images/25th_poster', 0, 1),
(23, 'Yummy Square Shaped Twenty Fifth Anniversary Cake', 'Celebrate the twenty five years of togetherness with this heavenly delicious photo cake.', 'images/25th_square', 0, 1),
--Anniversary Cakes For Parents
(24, 'Square Poster Mom & Dad Anniversary Cake', 'Give your mom and dad a pleasant surprise by sending our freshly baked cake on their anniversary.', 'images/parent_poster', 0, 1),
(24, 'Wrapped Gift Fondant Cake', 'This amazing cake is dedicated to the lovebirds who are celebrating their happy anniversary. ', 'images/wrap_gift', 0, 1),
--Anniversary Photo Cakes
(25, 'Round Red Velvet Photo Cake', 'A classic red velvet flavoured cake with a dash of personalization is the perfect combination to surprise your loved ones.', 'images/red-velvet_photo', 0, 1),
(25, 'Anniversary Photo Cake 1 Round Shape', 'Is your anniversary soon approaching? Then, treat your honey over this delectable photo cake to say cheers to our togetherness.', 'images/1round_photo', 0, 1),
(25, 'Anniversary Photo Cake 6 Square Shape', 'Present this delightful cake to your significant other and show your love to them and also let them know how lucky you feel to have them in your life.', 'images/6square_photo', 0, 1),
(25, 'Anniversary Photo Cake 3 Round Shape', 'This photo cake is a true bliss brimming with love. Because some celebrations need to be extra special, just like your anniversary.', 'images/3round_photo', 0, 1),
(25, 'Anniversary Photo Cake 7 Square Shape', '"We meant to be together." Forever Mine", "You belong to me." Yes, it"s your wedding day, and you are trying to impress your loving husband or wife.', 'images/7square_photo', 0, 1),
--Flours(Traditional Ingredients)
(26, 'Grand Place Pure Cocoa Powder 50g', 'Cocoa powder is a basic and important ingredient, indispensable in cakes, tiramisu, nama...', 'images/cocoa_powder', 0, 1),
(26, 'Peppermint Powder 50g', 'The taste and medicinal properties of peppermint powder are used in many areas of life. In cuisine, peppermint powder is used as a flavoring in some baked goods, or used to prepare meats, soups, sauces, salad dressings,...', 'images/mint_powder', 0, 1),
(26, 'Beetroot powder 10g', 'With its beautiful red color, beetroot powder has long been seen as a natural color therapy for food, not only the beautiful color is true, but also has a delicious taste for the dishes it incorporates.', 'images/beetroot_powder', 0, 1),
(26, 'Strawberry flour 50g', 'Super delicious 50g small package strawberry powder for ice cream dishes, ice cream powder, in bakery products, nougat candy, beverages...', 'images/strawberry_powder', 0, 1),
(26, 'Purple sweet potato flour 10g', 'Purple sweet potatoes contain many nutrients and especially the content of antoxans is relatively high, accounting for 51.5 to 174.7 mg/100 g of raw materials.', 'images/sweet-potato_flour', 0, 1),
--Others(Traditional Ingredients)
(27, 'Bronze gelatin leaf 1kg', 'Gelatin is extracted from the collagen itself found in bones, animal skin such as pig skin, or in the collagen of plants (red algae, fruits,..). This is a protein that is tasteless, odorless, transparent or produced with a yellowish color', 'images/bronze_gelatin', 0, 1),
(27, 'French Grape Sugar 100g', 'Used as a freezer in chow pho, spongy in yogurt or baking', 'images/grape_sugar', 0, 1),
(27, 'Rovin Hoang Yen Short-Fiber Fishing Vegetables 20g', 'Rovin Hoang Yen Short-Fiber Vegetables 20g is a fiber-rich product produced from golden thread seaweed, helping housewives save time in preparing delicious and beautiful salads and salads.', 'images/rovin_short-fiber', 0, 1),
(27, 'Japanese Algae Sugar 150g', 'Algae sugar, also known as trehalose, has been popular since 2000, when a Japanese company found a way to produce sugar to improve human health. Many people also consider trehalose as a miraculous alternative sweetener.', 'images/agale_suger', 0, 1),
(27, 'Dai Long Dolphin Fishing Vegetable Jelly 2.35kg', 'The strong attraction for drinks is thanks to the contribution of dolphin fishing jelly with a funny, fancy shape, and very eye-catching color. Crispy and flexible dolphin jelly delights in harmony with a variety of drinks.', 'images/dolphin_jelly', 0, 1),
--Flours(Korea/Japan Ingredients)
(28, 'Miwon Crispy Fried Dough 100g', 'Miwon crispy fried dough is a combination of flours and spices to form a multi-purpose fried dough with high nutritional quality, crunchy, soft foam, safe, convenient, vegetarian and salty.', 'images/miwon_crispy', 0, 1),
(28, 'Miwon Fried Dough 100g', 'Miwon 100g Fried Dough is a very convenient food processing fried dough that assists housewives in saving processing time. The fried dough product from the Miwon brand makes the dish more delicious and delicious.', 'images/miwon_fried-dough', 0, 1),
(28, 'Korean Fine Chili Powder Hae Cham 100g', 'In order for dishes to have attractive flavors and colors like Korean food, the indispensable spice is paprika. Paprika is the secret to creating an extremely eye-catching color that is not too spicy for many dishes such as rice cakes, kimchi, barbecue, ....', 'images/chili_powder', 0, 1),
--Others(Korea/Japan Ingredients)
(29, 'Gochujang Taeyang Chili Sauce for Korea 200g', 'With excellent spicy taste, Gochujang Taeyangcho is used to prepare many common dishes such as: Spicy Rice Cake, Mixed Rice, Noodles with soy sauce, mixed with Kimchi of all kinds,....', 'images/Gochujang_sauce', 0, 1),
(29, 'Fresh Udon Samlip Noodles 200g', 'Udon noodles are considered the national noodle dish of the cuisine of the land of cherry blossoms. Udon originated in Kagawa (Northeast Japan).', 'images/udon', 0, 1),
(29, 'Flat green bamboo rice roll blinds', 'Currently, there are many people who are passionate about Japanese and Korean food. Of course, it is impossible not to mention rice rolls, to make Japanese shushi or Gimbap Korean rice rolls with fancy aromas, an indispensable tool is the flat green bamboo rice roll blinds.', 'images/bamboo_rice_roll', 0, 1),
(29, '100g crab bars', 'Crab sticks are an extremely popular dish for young people not only because of the delicious taste of crabs but also because of their low price, ease of use and preparation.', 'images/crab_bar', 0, 1),
(29, 'Dried seaweed Badanhaecho 25g', 'Seaweed is a wonderful food that the Japanese have called "precious water vegetables" or "the source of happiness of the sea" since ancient times.', 'images/dried_seaweed', 0, 1),
--Jam, honey
(30, 'Fine peanut butter 170g', 'The combination of Fine Peanut Butter with bread is the perfect way to start the day. This excellent breakfast will give you plenty of energy for the day.', 'images/peanut_butter', 0, 1),
(30, 'Honey 600ml', 'Honey is one of the familiar ingredients in life and is used as a folk remedy or as an ingredient for more attractive and eye-catching dishes.', 'images/honey', 0, 1),
(30, 'Nutella Nutella Jam 200g', 'Nutella Nutella 200g (also known as Hazelnut Jam) is a fairly old product, on the market since 1964.', 'images/nutella', 0, 1),
(30, 'Golden farm Raspberry Jam 210g', 'Jam is an indispensable product in modern life, rooted in its delicious taste and convenience. Golden farm Raspberry Jam 210g not only stops at the inherent use of jam, but it also goes beyond that.', 'images/rasberry_jam', 0, 1),
(30, 'Liquid kiwi jam 120g', 'To add flavor to cakes and drinks, fruit jams are a reasonable choice.', 'images/kiwi_jam', 0, 1),
--Cheese
(31, 'Korean cheddar cheese powder 50g', 'Korean cheddar cheese powder, a unique and interesting product in cuisine.', 'images/chedda_korea', 0, 1),
(31, 'Sweet Shake Cheese Powder 50g', 'Cheese powder is made from cheese when it is squeezed out of water and dried.', 'images/shake_cheese_powder', 0, 1),
(31, 'Mascarpone Cheese Powder 50g', 'Discover the amazing taste of mascarpone cheese powder, a perfect choice for your favorite desserts and dishes!', 'images/mascarpone_cheese', 0, 1),
(31, 'Mozzarella cheese (100g unit, pack about 200g)', 'Cheese is an important source of calcium in the diet for children and adults. Most cheeses are good for an excellent source of calcium to meet daily calcium needs.', 'images/mozzarella', 0, 1),
--Basic Tools
(32, '30cm glass turntable', 'When you finish making a gato cake or pastry, you can put the base on it and use decorations to make the cake more beautiful... With a high-quality turntable, it can make it easy for you to place cakes and decorate in the simplest and most convenient way.', 'images/turntable', 0, 1),
(32, '28cm plastic turntable', 'When you finish making a gato cake or pastry, you can put the base on it and use decorations to make the cake more beautiful... With a high-quality turntable, it can make it easy for you to place cakes and decorate in the simplest and most convenient way.', 'images/plastic_turntable', 0, 1),
(32, 'Opaque white 120ml mist spray bottle', 'In fact, during the baking process, there are many types of cakes that need to be moistened before being baked.', 'images/spray_bottle', 0, 1),
(32, 'Stainless steel measuring spoon set 5 pcs (tsp,ml unit)', 'The measuring spoon set is among the basic baking tools that every person who wants to make a cake must have.', 'images/measuring_spoon', 0, 1),
(32, '28cm Wood Pulp Roller Rolling', 'Rolling dough is used a lot when making cookies, rolling out thousand-layer dough, bread, fondant... The size of 28cm fits the handle with sturdy wood.', 'images/roller', 0, 1),
--Other Tools
(33, '28cm checkered coarse fabric heat resistant gloves (90g)', 'A good pair of heat-resistant gloves will help protect your hands when taking hot food, especially from the oven or microwave.', 'images/heat-resistant_gloves', 0, 1),
(33, 'Egg White Separator', 'The egg white separator is a basic baking tool that any baking lover needs to have in their kitchen.', 'images/egg_seperator', 0, 1),
(33, 'Molded silicone brushes', 'Silicone brushes are the basic tool of bakers. Tools are used to evenly sweep butter, spread cream on the surface of cakes, or fruit jam syrups to make the cake base softer and moister...', 'images/brushes', 0, 1),
--Boxs
(34, '1000ml PET lid kraft paper bowl (10 pcs)', 'When buying takeaway food at restaurants, we often see food put in plastic boxes, styrofoam boxes, which are both harmful to human health and adversely affect the environment.', 'images/paper_bowl', 0, 1),
(34, 'Cupcake Box with 6 Cells Cement Paper Strap', 'The 6-cell cement paper strap cupcake box is designed with cardboard paper with embossed lines that make it easier to fold the box. The sturdy paper helps the box stand and hold the weight of the cupcake, and the box also has a clear plastic part so that we can see the cake inside.', 'images/cupcake_box', 0, 1),
--Bags
(35, 'Red God Cat Pineapple Cake Bag and Box Set', 'Taiwanese pineapple cake is a famous and popular dish in this most populous country in the world.', 'images/pineapple_cake_bag', 0, 1),
(35, 'Brown roll bag with bold text 5x11cm (100 pcs)', '', 'images/roll_bag', 0, 1);
go
-- [product_item]
...
(23, 14, 1),
(23, 6, 0);--3
--Common: 12(2), 11(3), 6(2), 7(3), 5(2), 4(2)
--Distinct: 15, 8, 9, 10, 2, 16, 1, 14 
go
...
(1, 1, 1, 1, 4, 1318000, 1, '2024-09-01 01:13:39', '2024-09-01 13:13:39', '2024-09-02 12:13:39', '2024-09-04 01:13:39', null, null),
(1, 2, 1, 1, 4, 1048000, 2, '2024-05-26 19:49:27', '2024-05-27 07:49:27', '2024-05-28 05:49:27', '2024-05-30 19:49:27', null, null),
(2, 3, 2, 2, 4, 2239000, 3, '2024-06-12 12:59:50', '2024-06-13 00:59:50', '2024-06-13 20:59:50', '2024-06-16 12:59:50', null, null),
(2, 4, 2, 2, 4, 3261000, 4, '2024-02-15 22:38:19', '2024-02-16 10:38:19', '2024-02-17 07:38:19', '2024-02-19 22:38:19', null, null),
(3, 5, 4, 3, 4, 4911000, 5, '2024-04-22 13:23:05', '2024-04-23 01:23:05', '2024-04-23 23:23:05', '2024-04-26 13:23:05', null, null),
(3, 1, 4, 3, 4, 334000, 6, '2024-09-29 15:00:37', '2024-09-30 03:00:37', '2024-10-01 02:00:37', '2024-10-02 15:00:37', null, null),
(4, 2, 6, 4, 4, 583000, 7, '2024-09-29 16:55:47', '2024-09-30 04:55:47', '2024-10-01 03:55:47', '2024-10-03 16:55:47', null, null),
(4, 3, 6, 4, 4, 1502000, 8, '2024-07-04 19:17:56', '2024-07-05 07:17:56', '2024-07-06 03:17:56', '2024-07-07 19:17:56', null, null),
(5, 4, 7, 5, 4, 1036000, 8, '2024-04-20 16:21:30', '2024-04-21 04:21:30', '2024-04-22 02:21:30', '2024-04-24 16:21:30', null, null),
(5, 5, 7, 5, 4, 1173000, 10, '2024-09-10 10:48:34', '2024-09-10 22:48:34', '2024-09-11 21:48:34', '2024-09-13 10:48:34', null, null),
(6, 1, 8, 6, 4, 1712000, 11, '2024-01-04 04:01:43', '2024-01-04 16:01:43', '2024-01-05 13:01:43', '2024-01-07 04:01:43', null, null),
(6, 2, 8, 6, 4, 958000, 12, '2024-02-23 07:38:35', '2024-02-23 19:38:35', '2024-02-24 15:38:35', '2024-02-26 07:38:35', null, null),
(7, 3, 10, 7, 4, 1406000, 13, '2024-04-29 09:45:22', '2024-04-29 21:45:22', '2024-04-30 17:45:22', '2024-05-03 09:45:22', null, null),
(7, 4, 10, 7, 4, 3055000, 14, '2024-10-08 01:16:19', '2024-10-08 13:16:19', '2024-10-09 11:16:19', '2024-10-12 01:16:19', null, null),
(8, 5, 12, 8, 4, 2706000, NULL, '2024-07-22 23:18:36', '2024-07-23 11:18:36', '2024-07-24 08:18:36', '2024-07-25 23:18:36', null, null),
(8, 1, 12, 8, 4, 772000, NULL, '2024-08-24 00:05:05', '2024-08-24 12:05:05', '2024-08-25 11:05:05', '2024-08-28 00:05:05', null, null),
(9, 2, 14, 9, 4, 373000, 1, '2024-09-10 02:39:48', '2024-09-10 14:39:48', '2024-09-11 13:39:48', '2024-09-13 02:39:48', null, null),
(9, 3, 14, 9, 4, 2330000, 2, '2024-10-23 02:13:17', '2024-10-23 14:13:17', '2024-10-24 13:13:17', '2024-10-26 02:13:17', null, null),
(10, 4, 16, 10, 4, 1754000, 3, '2024-09-21 09:42:03', '2024-09-21 21:42:03', '2024-09-22 17:42:03', '2024-09-24 09:42:03', null, null),
(10, 5, 16, 10, 4, 1837000, 4, '2024-09-01 15:52:01', '2024-09-02 03:52:01', '2024-09-03 02:52:01', '2024-09-05 15:52:01', null, null),
(11, 1, 18, 11, 4, 2663000, 5, '2024-09-18 14:38:18', '2024-09-19 02:38:18', '2024-09-20 01:38:18', '2024-09-21 14:38:18', null, null),
(11, 2, 18, 11, 4, 5174000, 5, '2024-11-05 07:46:04', '2024-11-05 19:46:04', '2024-11-06 18:46:04', '2024-11-09 07:46:04', null, null),
(12, 3, 20, 12, 4, 2923000, 7, '2024-03-16 21:30:47', '2024-03-17 09:30:47', '2024-03-18 06:30:47', '2024-03-19 21:30:47', null, null),
(12, 4, 20, 12, 4, 621000, 8, '2024-04-21 00:21:57', '2024-04-21 12:21:57', '2024-04-22 11:21:57', '2024-04-25 00:21:57', null, null),
(13, 5, 22, 13, 4, 1874000, 9, '2024-05-27 18:34:04', '2024-05-28 06:34:04', '2024-05-29 03:34:04', '2024-05-31 18:34:04', null, null),
(13, 1, 22, 13, 4, 2019000, 10, '2024-05-07 04:09:23', '2024-05-07 16:09:23', '2024-05-08 13:09:23', '2024-05-11 04:09:23', null, null),
(14, 2, 24, 14, 4, 1860000, 11, '2024-09-30 20:12:11', '2024-10-01 08:12:11', '2024-10-02 04:12:11', '2024-10-03 20:12:11', null, null),
(14, 3, 24, 14, 4, 1518000, 12, '2024-03-18 04:27:09', '2024-03-18 16:27:09', '2024-03-19 13:27:09', '2024-03-21 04:27:09', null, null),
(15, 4, 26, 15, 4, 3773000, 13, '2024-01-07 08:02:39', '2024-01-07 20:02:39', '2024-01-08 18:02:39', '2024-01-10 08:02:39', null, null),
(15, 5, 27, 15, 4, 2730000, 14, '2024-07-14 05:40:40', '2024-07-14 17:40:40', '2024-07-15 15:40:40', '2024-07-17 05:40:40', null, null),
(16, 1, 28, 16, 4, 953000, NULL, '2024-05-21 05:07:30', '2024-05-21 17:07:30', '2024-05-22 16:07:30', '2024-05-25 05:07:30', null, null),
(16, 2, 29, 16, 4, 1491000, NULL, '2024-06-09 04:48:31', '2024-06-09 16:48:31', '2024-06-10 14:48:31', '2024-06-12 04:48:31', null, null),
(17, 3, 30, 17, 4, 2390000, 1, '2024-06-18 11:40:16', '2024-06-18 23:40:16', '2024-06-19 19:40:16', '2024-06-22 11:40:16', null, null),
(17, 4, 30, 17, 4, 1734000, 2, '2024-09-06 19:15:22', '2024-09-07 07:15:22', '2024-09-08 06:15:22', '2024-09-10 19:15:22', null, null),
(18, 5, 32, 18, 4, 3167000, 4, '2024-01-24 10:02:34', '2024-01-24 22:02:34', '2024-01-25 21:02:34', '2024-01-28 10:02:34', null, null),
(18, 1, 32, 18, 4, 7763000,5, '2024-07-29 18:32:36', '2024-07-30 06:32:36', '2024-07-31 02:32:36', '2024-08-01 18:32:36', null, null),
(19, 2, 34, 19, 4, 759000, 5, '2024-01-19 07:54:33', '2024-01-19 19:54:33', '2024-01-20 17:54:33', '2024-01-23 07:54:33', null, null),
(19, 3, 34, 19, 4, 1930000, 7, '2024-03-30 18:27:31', '2024-03-31 06:27:31', '2024-04-01 02:27:31', '2024-04-02 18:27:31', null, null),
(20, 4, 36, 20, 4, 2489000, 8, '2024-10-02 18:13:13', '2024-10-03 06:13:13', '2024-10-04 05:13:13', '2024-10-06 18:13:13', null, null),
(20, 5, 36, 20, 4, 2236000, 9, '2024-09-13 21:14:13', '2024-09-14 09:14:13', '2024-09-15 06:14:13', '2024-09-16 21:14:13', null, null),
(21, 1, 38, 21, 4, 2603000, 10, '2024-08-08 07:06:10', '2024-08-08 19:06:10', '2024-08-09 18:06:10', '2024-08-11 07:06:10', null, null),
(21, 2, 38, 21, 4, 4798000, 11, '2024-12-29 21:00:49', '2024-12-30 09:00:49', '2024-12-31 05:00:49', '2025-01-01 21:00:49', null, null),
(22, 3, 39, 22, 4, 897000, 12, '2024-01-20 00:11:19', '2024-01-20 12:11:19', '2024-01-21 10:11:19', '2024-01-23 00:11:19', null, null),
(22, 4, 39, 22, 4, 2498000, 13, '2024-10-31 23:35:21', '2024-11-01 11:35:21', '2024-11-02 10:35:21', '2024-11-03 23:35:21', null, null),
(23, 5, 41, 23, 4, 2518000, 4, '2024-04-01 17:38:10', '2024-04-02 05:38:10', '2024-04-03 04:38:10', '2024-04-05 17:38:10', null, null),
(23, 1, 41, 23, 4, 2035000, NULL, '2024-07-15 15:08:06', '2024-07-16 03:08:06', '2024-07-16 23:08:06', '2024-07-19 15:08:06', null, null),
(24, 2, 43, 24, 4, 5998000, NULL, '2024-06-14 16:29:23', '2024-06-15 04:29:23', '2024-06-16 00:29:23', '2024-06-18 16:29:23', null, null),
(24, 3, 43, 24, 4, 3865000, 10, '2024-11-18 18:27:10', '2024-11-19 06:27:10', '2024-11-20 05:27:10', '2024-11-21 18:27:10', null, null),
(25, 4, 45, 25, 4, 797000, 6, '2024-12-26 10:48:16', '2024-12-26 22:48:16', '2024-12-27 18:48:16', '2024-12-30 10:48:16', null, null),
(25, 5, 45, 25, 4, 3012000, 11, '2024-06-29 10:47:26', '2024-06-29 22:47:26', '2024-06-30 19:47:26', '2024-07-03 10:47:26', null, null);
go
-- [order_line]
insert into [order_line]([product_item_id], [order_id], [qty], [price], [discount_price], [note]) values
(1, 1, 1, 163000, '', ''),
(3, 1, 2, 208000, '', ''),
(5, 1, 3, 253000, '', ''),
(7, 2, 1, 193000, '', ''),
...
go
-- [user_review]
insert into [user_review]([order_product_id], [user_id], [rating], [feedback], [review_image], [status_id], [comment_date] , [approved_date], [reject_date], [valid_date], [is_hide], [is_deleted]) values
(1, 1, 5, N'This taste is like the heaven in my mouth. I love it. I will order another in future.', N'', 1, CAST(N'2024-09-04T02:13:39.000' AS DateTime), CAST(N'2024-09-04T04:13:39.000' AS DateTime), null, CAST(N'2024-09-11T04:13:00.000' AS DateTime), -1, 1),
(2, 1, 4, N'The flavor is melting on my tongue.', N'', 1, CAST(N'2024-09-04T02:15:39.000' AS DateTime), CAST(N'2024-09-04T04:13:39.000' AS DateTime), null, CAST(N'2024-09-11T04:13:00.000' AS DateTime), -1, 1),
(3, 1, 3, N'The flavor is normal but I still like it.', N'', 1, CAST(N'2024-09-04T02:17:39.000' AS DateTime), CAST(N'2024-09-04T04:13:39.000' AS DateTime), null, CAST(N'2024-09-11T04:13:00.000' AS DateTime), -1, 1),
(7, 2, 2, N'Not like my imagine.', N'', 1, CAST(N'2024-06-16T13:59:50.000' AS DateTime), CAST(N'2024-06-16T16:59:50.000' AS DateTime), null, CAST(N'2024-06-23T16:59:00.000' AS DateTime), -1, 1),
(8, 2, 5, N'This is very good!', N'', 1, CAST(N'2024-06-16T14:59:50.000' AS DateTime), CAST(N'2024-06-16T16:59:50.000' AS DateTime), null, CAST(N'2024-06-23T16:59:00.000' AS DateTime), -1, 1),
(9, 2, 5, N'How they can make it! I love it!', N'', 1, CAST(N'2024-06-16T15:59:50.000' AS DateTime), CAST(N'2024-06-16T16:59:50.000' AS DateTime), null, CAST(N'2024-06-23T16:59:00.000' AS DateTime), -1, 1),
(13, 3, 5, N'Amazing taste I never seen.', N'', 1, CAST(N'2024-04-26T16:23:05.000' AS DateTime), CAST(N'2024-04-26T18:23:05.000' AS DateTime), null, CAST(N'2024-05-03T18:23:00.000' AS DateTime), -1, 1),
(14, 3, 4, N'That OK!', N'', 1, CAST(N'2024-04-26T17:23:05.000' AS DateTime), CAST(N'2024-04-26T18:23:05.000' AS DateTime), null, CAST(N'2024-05-03T18:23:00.000' AS DateTime), -1, 1),
(15, 3, 5, N'This thing is extremely good!', N'', 1, CAST(N'2024-04-26T14:23:05.000' AS DateTime), CAST(N'2024-04-26T18:23:05.000' AS DateTime), null, CAST(N'2024-05-03T18:23:00.000' AS DateTime), -1, 1),
(19, 4, 5, N'Sweety!', N'', 1, CAST(N'2024-10-03T17:55:47.000' AS DateTime), CAST(N'2024-10-03T20:55:47.000' AS DateTime), null, CAST(N'2024-10-10T20:55:00.000' AS DateTime), -1, 1),
(20, 4, 2, N'More sweet than I needed!', N'', 1, CAST(N'2024-10-03T18:55:47.000' AS DateTime), CAST(N'2024-10-03T20:55:47.000' AS DateTime), null, CAST(N'2024-10-10T20:55:00.000' AS DateTime), -1, 1),
(21, 4, 4, N'I love sweet! ', N'', 1, CAST(N'2024-10-03T19:55:47.000' AS DateTime), CAST(N'2024-10-03T20:55:47.000' AS DateTime), null, CAST(N'2024-10-10T20:55:00.000' AS DateTime), -1, 1),
(25, 5, 5, N'The cake was absolutely amazing! It tasted better than any other cake I''ve had.', N'', 1, CAST(N'2024-04-24T16:21:30.000' AS DateTime), CAST(N'2024-04-24T19:21:30.000' AS DateTime), null, CAST(N'2024-05-01T19:21:00.000' AS DateTime), -1, 1),
(26, 5, 5, N'Your cakes are always so moist and flavorful. I''m a repeat customer for sure.', N'', 1, CAST(N'2024-04-24T17:21:30.000' AS DateTime), CAST(N'2024-04-24T19:21:30.000' AS DateTime), null, CAST(N'2024-05-01T19:21:00.000' AS DateTime), -1, 1),
(27, 5, 5, N'The decoration on my wedding cake was stunning. It was the perfect centerpiece.', N'', 1, CAST(N'2024-04-24T18:21:30.000' AS DateTime), CAST(N'2024-04-24T19:21:30.000' AS DateTime), null, CAST(N'2024-05-01T19:21:00.000' AS DateTime), -1, 1),
(31, 6, 5, N'I ordered a custom cake for my daughter''s birthday and it was exactly what I envisioned.', N'', 1, CAST(N'2024-01-07T06:01:43.000' AS DateTime), CAST(N'2024-01-07T08:01:43.000' AS DateTime), null, CAST(N'2024-01-14T08:01:00.000' AS DateTime), -1, 1),
(32, 6, 5, N'The cupcakes were a huge hit at my baby shower. Everyone loved the flavors.', N'', 1, CAST(N'2024-01-07T05:01:43.000' AS DateTime), CAST(N'2024-01-07T08:01:43.000' AS DateTime), null, CAST(N'2024-01-14T08:01:00.000' AS DateTime), -1, 1),
(33, 6, 5, N'I''ve tried several of your cakes and they''re all delicious. Keep up the great work!', N'', 1, CAST(N'2024-01-07T07:01:43.000' AS DateTime), CAST(N'2024-01-07T08:01:43.000' AS DateTime), null, CAST(N'2024-01-14T08:01:00.000' AS DateTime), -1, 1),
(37, 7, 5, N'Your cake shop is my go-to for special occasions. The quality is always top-notch.', N'', 1, CAST(N'2024-05-03T09:45:22.000' AS DateTime), CAST(N'2024-05-03T10:45:22.000' AS DateTime), null, CAST(N'2024-05-10T10:45:00.000' AS DateTime), -1, 1),
(38, 7, 5, N'The customer service was excellent. They helped me choose the perfect cake for my needs.', N'', 1, CAST(N'2024-05-03T09:48:22.000' AS DateTime), CAST(N'2024-05-03T10:48:22.000' AS DateTime), null, CAST(N'2024-05-10T10:48:00.000' AS DateTime), -1, 1),
(39, 7, 5, N'The cake was so fresh and the frosting was light and fluffy.', N'', 1, CAST(N'2024-05-03T09:49:22.000' AS DateTime), CAST(N'2024-05-03T10:49:22.000' AS DateTime), null, CAST(N'2024-05-10T10:49:00.000' AS DateTime), -1, 1),
(43, 8, 5, N'I''m impressed with the variety of flavors and fillings you offer.', N'', 1, CAST(N'2024-07-25T23:20:36.000' AS DateTime), CAST(N'2024-07-25T23:50:36.000' AS DateTime), null, CAST(N'2024-08-01T23:50:00.000' AS DateTime), -1, 1),
(44, 8, 3, N'The cake was okay, but not the best I''ve had.', N'', 1, CAST(N'2024-07-25T23:21:36.000' AS DateTime), CAST(N'2024-07-25T23:50:36.000' AS DateTime), null, CAST(N'2024-08-01T23:50:00.000' AS DateTime), -1, 1),
(45, 8, 3, N'The cake was a bit too sweet for my taste.', N'', 1, CAST(N'2024-07-25T23:33:36.000' AS DateTime), CAST(N'2024-07-25T23:50:36.000' AS DateTime), null, CAST(N'2024-08-01T23:50:00.000' AS DateTime), -1, 1),
(49, 9, 4, N'The decoration was simple, but I liked it.', N'', 1, CAST(N'2024-09-13T03:39:48.000' AS DateTime), CAST(N'2024-09-13T05:39:48.000' AS DateTime), null, CAST(N'2024-09-20T05:39:00.000' AS DateTime), -1, 1),
(50, 9, 2, N'The customer service was average.', N'', 1, CAST(N'2024-09-13T04:39:48.000' AS DateTime), CAST(N'2024-09-13T05:39:48.000' AS DateTime), null, CAST(N'2024-09-20T05:39:00.000' AS DateTime), -1, 1),
(51, 9, 4, N'The cake was a good value for the price.', N'', 1, CAST(N'2024-09-13T02:40:48.000' AS DateTime), CAST(N'2024-09-13T05:40:48.000' AS DateTime), null, CAST(N'2024-09-20T05:40:00.000' AS DateTime), -1, 1),
(55, 10, 3, N'The cake was fresh, but lacked flavor.', N'', 1, CAST(N'2024-09-24T09:44:03.000' AS DateTime), CAST(N'2024-09-24T10:44:03.000' AS DateTime), null, CAST(N'2024-10-01T10:44:00.000' AS DateTime), -1, 1),
(56, 10, 5, N'The cake was so beautiful, it was almost too pretty to eat!', N'', 1, CAST(N'2024-09-24T09:45:03.000' AS DateTime), CAST(N'2024-09-24T10:45:03.000' AS DateTime), null, CAST(N'2024-10-01T10:45:00.000' AS DateTime), -1, 1),
(57, 10, 5, N'I''ve tried cakes from other shops, but yours are the best by far.', N'', 1, CAST(N'2024-09-24T09:46:03.000' AS DateTime), CAST(N'2024-09-24T10:46:03.000' AS DateTime), null, CAST(N'2024-10-01T10:46:00.000' AS DateTime), -1, 1),
(61, 11, 5, N'The cake was the perfect ending to our wedding reception.', N'', 1, CAST(N'2024-09-21T14:55:18.000' AS DateTime), CAST(N'2024-09-21T17:55:18.000' AS DateTime), null, CAST(N'2024-09-28T17:55:00.000' AS DateTime), -1, 1),
(62, 11, 5, N'I''m so glad I chose your cake shop for my daughter''s birthday.', N'', 1, CAST(N'2024-09-21T15:38:18.000' AS DateTime), CAST(N'2024-09-21T17:38:18.000' AS DateTime), null, CAST(N'2024-09-28T17:38:00.000' AS DateTime), -1, 1),
(63, 11, 5, N'The cake was the talk of the party.', N'', 1, CAST(N'2024-09-21T16:38:18.000' AS DateTime), CAST(N'2024-09-21T17:38:18.000' AS DateTime), null, CAST(N'2024-09-28T17:38:00.000' AS DateTime), -1, 1),
(67, 12, 1, N'The cake was a complete disaster.', N'', 1, CAST(N'2024-03-19T22:30:47.000' AS DateTime), CAST(N'2024-03-19T23:30:47.000' AS DateTime), null, CAST(N'2024-03-26T23:30:00.000' AS DateTime), -1, 1),
(68, 12, 1, N'The cake was a total waste of money.', N'', 1, CAST(N'2024-03-19T22:45:47.000' AS DateTime), CAST(N'2024-03-19T23:45:47.000' AS DateTime), null, CAST(N'2024-03-26T23:45:00.000' AS DateTime), -1, 1),
(69, 12, 1, N'I was so disappointed with the cake.', N'', 1, CAST(N'2024-03-19T22:55:47.000' AS DateTime), CAST(N'2024-03-19T23:55:47.000' AS DateTime), null, CAST(N'2024-03-26T23:55:00.000' AS DateTime), -1, 1),
(73, 13, 3, N'The cake was just okay.', N'', 1, CAST(N'2024-05-31T18:44:04.000' AS DateTime), CAST(N'2024-05-31T19:44:04.000' AS DateTime), null, CAST(N'2024-06-07T19:44:00.000' AS DateTime), -1, 1),
(74, 13, 2, N'The cake was a bit disappointing.', N'', 1, CAST(N'2024-05-31T18:50:04.000' AS DateTime), CAST(N'2024-05-31T19:50:04.000' AS DateTime), null, CAST(N'2024-06-07T19:50:00.000' AS DateTime), -1, 1),
(75, 13, 3, N'The cake was average.', N'', 1, CAST(N'2024-05-31T18:58:04.000' AS DateTime), CAST(N'2024-05-31T19:58:04.000' AS DateTime), null, CAST(N'2024-06-07T19:58:00.000' AS DateTime), -1, 1),
(79, 14, 3, N'The cake was a bit overpriced.', N'', 1, CAST(N'2024-10-03T20:13:11.000' AS DateTime), CAST(N'2024-10-03T23:13:11.000' AS DateTime), null, CAST(N'2024-10-10T23:13:00.000' AS DateTime), -1, 1),
(80, 14, 5, N'The cake was the highlight of the party.', N'', 1, CAST(N'2024-10-03T21:12:11.000' AS DateTime), CAST(N'2024-10-03T23:12:11.000' AS DateTime), null, CAST(N'2024-10-10T23:12:00.000' AS DateTime), -1, 1),
(81, 14, 5, N'The cake was so delicious, it melted in my mouth.', N'', 1, CAST(N'2024-10-03T22:12:11.000' AS DateTime), CAST(N'2024-10-03T23:12:11.000' AS DateTime), null, CAST(N'2024-10-10T23:12:00.000' AS DateTime), -1, 1),
(85, 15, 5, N'The cake was exactly what I wanted.', N'', 1, CAST(N'2024-01-10T08:30:39.000' AS DateTime), CAST(N'2024-01-10T09:30:39.000' AS DateTime), null, CAST(N'2024-01-17T09:30:00.000' AS DateTime), -1, 1),
(86, 15, 5, N'I''m so impressed with the quality of your cakes.', N'', 1, CAST(N'2024-01-10T08:33:39.000' AS DateTime), CAST(N'2024-01-10T09:33:39.000' AS DateTime), null, CAST(N'2024-01-17T09:33:00.000' AS DateTime), -1, 1),
(87, 15, 5, N'I will definitely order from your cake shop again.', N'', 1, CAST(N'2024-01-10T08:48:39.000' AS DateTime), CAST(N'2024-01-10T09:48:39.000' AS DateTime), null, CAST(N'2024-01-17T09:48:00.000' AS DateTime), -1, 1),
(91, 16, 1, N'The taste like shit I poop it', N'', 3, CAST(N'2024-05-25T05:08:30.000' AS DateTime), null, CAST(N'2024-05-25T06:08:30.000' AS DateTime), null, -1, 1),
(92, 16, 3, N'HANAHANDASWSDAWS', N'', 2, CAST(N'2024-05-25T05:13:30.000' AS DateTime), null, null, null, -1, 1),
(93, 16, 4, N'DDDDDDDDDDDDDD', N'', 2, CAST(N'2024-05-25T05:14:30.000' AS DateTime), null, null, null, -1, 1),
(97, 17, 1, N'What the fuck! what did you make?', N'', 3, CAST(N'2024-06-22T11:46:16.000' AS DateTime), null, CAST(N'2024-06-22T12:46:16.000' AS DateTime), null, -1, 1),
(98, 17, 1, N'Smelt like a bitch in the sunrise of the beach', N'', 3, CAST(N'2024-06-22T11:54:16.000' AS DateTime), null, CAST(N'2024-06-22T12:54:16.000' AS DateTime), null, -1, 1),
(99, 17, 5, N'Hello Hello', N'', 2, CAST(N'2024-06-22T12:30:16.000' AS DateTime), null, null, null, -1, 1),
(103, 18, 3, N'Bad or not bad is the rule of the world', N'', 2, CAST(N'2024-01-28T10:48:34.000' AS DateTime), null, null, null, -1, 1),
(104, 18, 2, N'Haha and Hehe is friend', N'', 2, CAST(N'2024-01-28T11:02:34.000' AS DateTime), null, null, null, -1, 1),
(105, 18, 4, N'Bokoboko chupapimonhanho', N'', 2, CAST(N'2024-01-28T12:02:34.000' AS DateTime), null, null, null, -1, 1),
(109, 19, 5, N'The War never changes', N'', 3, CAST(N'2024-01-23T07:55:33.000' AS DateTime), null, CAST(N'2024-01-23T08:55:33.000' AS DateTime), null, -1, 1),
(110, 19, 1, N'That''s why the capitalist work', N'', 2, CAST(N'2024-01-23T07:57:33.000' AS DateTime), null, null, null, -1, 1),
(111, 19, 1, N'F the P of T cake', N'', 2, CAST(N'2024-01-23T07:59:33.000' AS DateTime), null, null, null, -1, 1),
(115, 20, 3, N'Ninani', N'', 2, CAST(N'2024-10-06T19:13:13.000' AS DateTime), null, null, null, -1, 1),
(116, 20, 2, N'HOHOHO Hola ga charelon', N'', 2, CAST(N'2024-10-06T19:14:13.000' AS DateTime), null, null, null, -1, 1),
(117, 20, 5, N'Skibidibidiiiiiiiiii', N'', 2, CAST(N'2024-10-06T19:15:13.000' AS DateTime), null, null, null, -1, 1);
go
